...
SECRET_KEY = 'django-insecure-0&xo#tls3audzkb&zrq^4bg1openy&#rb*fpf57b-fo)=@zqpu'
...
WSGI_APPLICATION = 'SVMS.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'SVMS/static/')
]
